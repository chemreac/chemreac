...
_generated/decay_long.png: examples/examples/decay.py
	python3 $< --plot --savefig $@ --rates 1.0 --logy --logt --rtol 1e-13 --atol 1e-6 --scale-err 100.0 --plotlogy --nt 1024 --tend 1700

_generated/decay_long_damp.png: examples/examples/decay.py
	python3 $< --plot --savefig $@ --rates 1.0 --logy --logt --rtol 1e-13 --atol 1e-6 --scale-err 100.0 --plotlogy --nt 1024 --tend 1700 --sigm-damp
...
_generated/equilibrium_unscaled.png: examples/examples/equilibrium.py
	python3 $< --A0 1.0 --B0 1e-10 --C0 1e-30 --kf 10 --kb 1 --t0 0 --tend 5 --plot --plotlogy --plotlogt --savefig $@

_generated/equilibrium_scaled.png: examples/examples/equilibrium.py
	python3 $<  --scaling 1e10 --A0 1.0 --B0 1e-10 --C0 1e-30 --kf 10 --kb 1 --t0 0 --tend 5 --plot --plotlogy --plotlogt --savefig $@
...
_generated/const_surf_conc_logy_logx.png: examples/examples/const_surf_conc.py
	python3 $< --logx --logy --x0 1e-6 --scaling 1e-20 --factor 1e12 --plot --savefig $@
